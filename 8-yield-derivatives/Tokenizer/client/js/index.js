...
document.querySelectorAll('.supply-button').forEach(button => {
  button.addEventListener('click', function() {
    const amount = this.previousElementSibling.value;
    console.log('Supply amount:', amount);
    // Add logic for supplying tokens
  });
});
...
document.querySelectorAll('.withdraw-button').forEach(button => {
  button.addEventListener('click', function() {
    ...
    // Add logic for withdrawing tokens
  });
});

document.querySelectorAll('.tokenize-button').forEach(button => {
  button.addEventListener('click', function() {
    const amount = this.previousElementSibling.value;
    console.log('Tokenize amount:', amount);
    // Add logic for tokenizing tokens
  });
});
...
document.querySelectorAll('.redeem-button').forEach(button => {
  button.addEventListener('click', function() {
    ...
    // Add logic for redeeming tokens
  });
});
